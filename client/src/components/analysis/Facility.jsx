...
import { FacilitiesByCityGraph, FacilitiesByTypeGraph } from './Graphs';
...
export default function Facility(props) {
    return (
        <Section id="facility">
            ...
            {/* 두번째 단에 세부설명부분 */}
            <div className="analysisSubtitle1"><h2>자치구별 주변시설 현황</h2></div>
            ...
            <div className="graph1">
                <div>
                    <FacilitiesByCityGraph />         
                </div>
            </div>
            <div className="graph2">
                <h2>주변시설 종류별 현황</h2>
                <div>
                    <FacilitiesByTypeGraph cityId={props.cityId} />
                </div>
            </div>
        </Section> 
    )
